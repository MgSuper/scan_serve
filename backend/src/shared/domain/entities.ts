...
export interface MenuItem { id: string; restaurantId: string; branchId: string; menuId: string; categoryId: string; categoryName?: string; name: string; description?: string; imageUrl?: string; price: number; displayOrder: number; isAvailable: boolean; metadata: AuditMetadata; }
export interface CartItem { menuItemId: string; name: string; unitPrice: number; quantity: number; notes?: string; note?: string; modifiers: readonly string[]; }
...
export interface OrderItem { id: string; orderId: string; restaurantId: string; branchId: string; menuItemId: string; categoryId: string; categoryName?: string; imageUrl?: string; name: string; unitPrice: number; quantity: number; notes?: string; note?: string; modifiers: readonly string[]; metadata: AuditMetadata; }
